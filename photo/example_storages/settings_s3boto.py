...
DEFAULT_FILE_STORAGE = 'photo.example_storages.s3utils.MediaS3BotoStorage'
STATICFILES_STORAGE = 'photo.example_storages.s3utils.StaticS3BotoStorage'

try:
    # If you want to test the photo with S3, you'll have to configure the
